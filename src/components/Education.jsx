  ...
  const educationData = [
    {
      ...
      duration: "2023 — 2027",
      description: "Focused on Software Engineering, Data Structures, and Full-Stack Development.",
    ...
    },
    {
      ...
      duration: "2019 — 2021",
      description: "Completed secondary education with a strong foundation in Mathematics and Physics.",
      color: "from-blue-500 to-cyan-500"
    }
  ];

  return (
    <section id="education" className="py-24 bg-[#0b0e14] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16 text-center">
          ...
          <h3 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-white">
            Education <span className="text-slate-500">&</span> Experience
          </h3>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h4 className="text-2xl font-bold text-white tracking-tight">Academic Journey</h4>
            </div>
            ...
            >
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 mb-6">
                   ...
                   <span className="text-[10px] font-bold text-emerald-400 uppercase tracking-widest">Open for roles</span>
                </div>
                
                <h5 className="text-3xl font-black text-white mb-4 uppercase tracking-tighter">
                  Aspiring <br /> <span className="text-indigo-500">Full-Stack Developer</span>
                </h5>
                
                <p className="text-slate-400 leading-relaxed mb-8">
                  Currently a <span className="text-white font-bold">Fresher</span> actively looking for Junior Full-Stack or Frontend positions. Ready to contribute to production-grade applications as an Intern or Junior Developer.
                </p>

                <ul className="space-y-4 mb-8">
                  {["MERN Stack Proficient", "Frontend Optimization", "Agile Mindset"].map((skill, i) => (
