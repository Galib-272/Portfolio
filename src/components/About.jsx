        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-slate-400 leading-relaxed mb-6 text-lg">
              I am a passionate <span className="text-white font-bold">Fullstack Developer</span> specializing in the MERN stack. My focus is on creating seamless user experiences through clean code and innovative design. 
            </p>
            <p className="text-slate-400 leading-relaxed mb-8">
              With a strong foundation in <span className="text-indigo-400">Frontend engineering</span>, I bridge the gap between complex backend logic and intuitive visual interfaces.
            </p>
          ...
          {/* Right Side: Skillset Bars (Replaced the Quick Bio section) */}
          <motion.div 
          ...
          >
            ...
            <div className="relative border border-white/10 bg-[#1a1f2e]/50 p-8 md:p-10 rounded-[3rem] backdrop-blur-md">
                <div className="flex items-center gap-4 mb-10">
                    ...
                    <span className="text-white font-black tracking-widest text-sm uppercase">Technical Skillset</span>
                </div>
