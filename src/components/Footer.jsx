  ...
  return (
    <footer className="bg-[#0b0e14] text-white border-t border-white/5 pt-16 pb-12 px-6 lg:px-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col gap-12">
        ...
        {/* TOP ROW: Brand and Tech Stack Pills */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 pb-2">
          
          {/* Brand Logo & Active Status Capsule */}
          ...
          {/* Minimalist Tech Icons Track */}
          <div className="flex items-center gap-6 px-6 py-3 rounded-2xl bg-[#1a1f2e]/20 border border-white/5 backdrop-blur-sm">
            <span className="text-xs font-semibold tracking-wider text-slate-600 uppercase mr-1 select-none">Stack</span>
            <span className="text-slate-500 text-sm font-bold hover:text-[#47A248] transition-colors cursor-default select-none">🍃 MongoDB</span>
            <span className="text-slate-500 text-sm font-bold hover:text-[#61DAFB] transition-colors cursor-default select-none">ex Express</span>
            <span className="text-slate-500 text-sm font-bold hover:text-[#61DAFB] transition-colors cursor-default select-none">⚛️ React</span>
            <span className="text-slate-500 text-sm font-bold hover:text-[#F7DF1E] transition-colors cursor-default select-none">⬢ Node</span>
          </div>

        </div>

        {/* BOTTOM ROW: Socials & Dynamic Copyright Meta */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-6 border-t border-white/5">
          
          {/* Actionable Social Utilities using inline SVGs */}
          ...
          {/* Legal / Location Identity String */}
          <div className="flex flex-col items-center md:items-end gap-1.5 text-center md:text-right">
            ...
            <p className="text-[9px] font-medium text-slate-600 uppercase tracking-widest">
              © {currentYear} All Rights Reserved <span className="mx-2 text-slate-700">|</span> Dhaka, BD (GMT+6)
            </p>
          </div>
